...
{
    _logincb = msgcb;
    NSString * loginUrl = [NSString stringWithFormat:@"%@%@",__kHOST,__kLOGIN];
    [HttpRequstManager POST:loginUrl withParams:@{@"username":user.username,@"password":user.userpassword} complete:^(NSData * data) {
