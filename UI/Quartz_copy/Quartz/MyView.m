...
-(void)bezier3
{
    ...
    CGContextMoveToPoint(crf, 10, 200);
    //三阶贝赛尔曲线
    CGContextAddCurveToPoint(crf, 85, 50, 235, 350, 310, 200);
    
//    CGContextAddLineToPoint(crf, 235, 350);
//    
//    CGContextAddLineToPoint(crf, 85, 50);
//    
//    CGContextAddLineToPoint(crf, 10, 200);
...
-(void)bezier
{
    ...
    CGContextMoveToPoint(crf, 10, 200);
    //二阶贝塞尔曲线
    CGContextAddQuadCurveToPoint(crf, 85, 100, 160, 200);
    
//    CGContextAddLineToPoint(crf, 85, 100);
//    
//    CGContextAddLineToPoint(crf, 10, 200);
    
    CGContextFillPath(crf);
    
    CGContextMoveToPoint(crf, 160, 200);
    
    CGContextAddQuadCurveToPoint(crf, 235, 300, 310, 200);
...
-(void)drawArc
{
    ...
    CGContextAddArc(crf, 160, 200, 150, M_PI/180.0*0, M_PI/180.0*180,0);
...
-(void)drawEllipse
{
    ...
    CGContextSetRGBFillColor(crf, 0, 1, 0, 1);
    //画圆
    CGContextAddEllipseInRect(crf, CGRectMake(10, 50, 300, 300));
